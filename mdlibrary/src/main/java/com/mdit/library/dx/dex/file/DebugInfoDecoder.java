...
package com.mdit.library.dx.dex.file;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import com.mdit.library.dx.dex.code.DalvCode;
import com.mdit.library.dx.dex.code.DalvInsnList;
import com.mdit.library.dx.dex.code.LocalList;
import com.mdit.library.dx.dex.code.PositionList;
import com.mdit.library.dx.rop.cst.CstMethodRef;
import com.mdit.library.dx.rop.cst.CstString;
import com.mdit.library.dx.rop.type.Prototype;
import com.mdit.library.dx.rop.type.StdTypeList;
import com.mdit.library.dx.rop.type.Type;
import com.mdit.library.dx.util.ByteArrayByteInput;
import com.mdit.library.dx.util.ByteInput;
import com.mdit.library.dx.util.ExceptionWithContext;
import com.mdit.library.dx.util.Leb128Utils;

import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_LINE;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_PC;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_END_LOCAL;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_END_SEQUENCE;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_FIRST_SPECIAL;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_LINE_BASE;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_LINE_RANGE;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_RESTART_LOCAL;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_SET_EPILOGUE_BEGIN;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_SET_FILE;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_SET_PROLOGUE_END;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL;
import static com.mdit.library.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL_EXTENDED;
